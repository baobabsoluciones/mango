...
logger1 = get_configured_logger(
    logger_type="example_logger_1",
    log_console_level=logging.INFO,
    log_console_format="%(asctime)s | %(levelname)s | %(message)s",
    log_console_datefmt="%Y-%m-%d %H:%M:%S",
    mango_color=True,
)
logger1.info("This is an info message for example_logger_1")

# # Example 2: File logging with custom format
# logger2 = get_configured_logger(
#     logger_type="example_logger_2",
#     log_file_path="example_log_2.log",
#     log_file_level=logging.DEBUG,
#     log_file_format="%(asctime)s | %(levelname)s | %(name)s: %(message)s",
#     log_file_datefmt="%Y-%m-%d %H:%M:%S",
# )
# logger2.debug("This is a debug message for example_logger_2")

# # Example 3: Console and file logging with different levels
# logger3 = get_configured_logger(
#     logger_type="example_logger_3",
#     log_console_level=logging.WARNING,
#     log_console_format="%(levelname)s - %(message)s",
#     log_console_datefmt="%H:%M:%S",
#     log_file_path="example_log_3.log",
#     log_file_level=logging.ERROR,
#     log_file_format="%(asctime)s | %(levelname)s | %(message)s",
#     log_file_datefmt="%Y-%m-%d %H:%M:%S",
# )
# logger3.warning("This is a warning message for example_logger_3")
# logger3.error("This is an error message for example_logger_3")

# # Example 4: JSON logging to a file
# logger4 = get_configured_logger(
#     logger_type="example_logger_4",
#     log_file_path="example_log_4.json",
#     json_fields=["level", "message", "time"],
# )
# logger4.info("This is an info message for example_logger_4")
# logger4.error("This is an error message for example_logger_4")

# Example 5: Colored console logging
logger5 = get_configured_logger(
    logger_type="example_logger_5",
    log_console_level=logging.INFO,
    log_console_format="%(asctime)s | %(levelname)s | %(message)s",
    log_console_datefmt="%Y-%m-%d %H:%M:%S",
    # mango_color=True,
)
logger5.info("This is an info message for example_logger_5 with color")
