...
def normalize_path(rel_path):
    """
    The normalize_path evaluator is used to convert relative paths into absolute paths.
    The normalize_path evaluator takes a relative path as an argument and returns the absolute path.
