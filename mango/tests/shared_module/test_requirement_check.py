...
class TestRequirementCheck(TestCase):
    ...
    def test_invalid_option_name(self):
        self.assertRaises(KeyError, check_dependencies, "invalid_option",pyproject_path="mockup.toml")

    def test_invalid_path(self):
        self.assertRaises(FileNotFoundError,check_dependencies,"some_option",pyproject_path="invalid_path.toml")